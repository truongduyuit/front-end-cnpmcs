...
@Injectable()
export class LoaiXeGroup4ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getST(): Observable<string> {
        let url_ = this.baseUrl + "/api/LoaiXeGroup4/getST";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetST(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetST(<any>response_);
                } catch (e) {
                    return <Observable<string>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetST(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    lOAIXE_Group4Search(ma: number | null | undefined, loaiXe_Ten: string | null | undefined): Observable<LoaiXeGroup4Dto[]> {
        let url_ = this.baseUrl + "/api/LoaiXeGroup4/LOAIXE_Group4Search?";
        if (ma !== undefined)
            url_ += "Ma=" + encodeURIComponent("" + ma) + "&"; 
        if (loaiXe_Ten !== undefined)
            url_ += "LoaiXe_Ten=" + encodeURIComponent("" + loaiXe_Ten) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LoaiXeGroup4Dto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<LoaiXeGroup4Dto[]>><any>_observableThrow(response_);
        }));
    }

    protected processLOAIXE_Group4Search(response: HttpResponseBase): Observable<LoaiXeGroup4Dto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(LoaiXeGroup4Dto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<LoaiXeGroup4Dto[]>(<any>null);
    }
}
...
@Injectable()
export class XeGroup4ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    getST(): Observable<string> {
        let url_ = this.baseUrl + "/api/XeGroup4/getST";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @ma (optional) 
     * @xe_Ten (optional) 
     * @xe_MaLoaiXe (optional) 
     * @return Success
     */
    xE_Group4Search(ma: number | null | undefined, xe_Ten: string | null | undefined, xe_MaLoaiXe: number | null | undefined): Observable<XeGroup4Dto[]> {
        let url_ = this.baseUrl + "/api/XeGroup4/XE_Group4Search?";
        if (ma !== undefined)
            url_ += "Ma=" + encodeURIComponent("" + ma) + "&"; 
        if (xe_Ten !== undefined)
            url_ += "Xe_Ten=" + encodeURIComponent("" + xe_Ten) + "&"; 
        if (xe_MaLoaiXe !== undefined)
            url_ += "Xe_MaLoaiXe=" + encodeURIComponent("" + xe_MaLoaiXe) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXE_Group4Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXE_Group4Search(<any>response_);
                } catch (e) {
                    return <Observable<XeGroup4Dto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<XeGroup4Dto[]>><any>_observableThrow(response_);
        }));
    }

    protected processXE_Group4Search(response: HttpResponseBase): Observable<XeGroup4Dto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(XeGroup4Dto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<XeGroup4Dto[]>(<any>null);
    }
}
...
export class LoaiXeGroup4Dto implements ILoaiXeGroup4Dto {
    ma!: number | undefined;
    loaiXe_Ten!: string | undefined;

    constructor(data?: ILoaiXeGroup4Dto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LoaiXeGroup4Dto {
        data = typeof data === 'object' ? data : {};
        let result = new LoaiXeGroup4Dto();
        result.init(data);
        return result;
    }
...
export interface ILoaiXeGroup4Dto {
    ma: number | undefined;
    loaiXe_Ten: string | undefined;
}
...
export class XeGroup4Dto implements IXeGroup4Dto {
    ma!: number | undefined;
    xe_Ma!: string | undefined;
    xe_Ten!: string | undefined;
    xe_Gia!: number | undefined;
    xe_Mau!: string | undefined;
    loaiXe_Ten!: string | undefined;
    loaiXe_Hang!: string | undefined;
    dangKiem_NgayDangKiem!: moment.Moment | undefined;
    dangKiem_Phi!: number | undefined;
    dkDuongBo_NgayDangKi!: moment.Moment | undefined;
    dkDuongBo_Phi!: number | undefined;
    baoHiemDansu_NgayDangKi!: moment.Moment | undefined;
    baoHiemDansu_Phi!: number | undefined;
    baoHiemTuNguyen_NgayDangKi!: moment.Moment | undefined;
    baoHiemTuNguyen_Phi!: number | undefined;

    constructor(data?: IXeGroup4Dto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.dangKiem_NgayDangKiem = data["dangKiem_NgayDangKiem"] ? moment(data["dangKiem_NgayDangKiem"].toString()) : <any>undefined;
            this.dangKiem_Phi = data["dangKiem_Phi"];
            this.dkDuongBo_NgayDangKi = data["dkDuongBo_NgayDangKi"] ? moment(data["dkDuongBo_NgayDangKi"].toString()) : <any>undefined;
            this.dkDuongBo_Phi = data["dkDuongBo_Phi"];
            this.baoHiemDansu_NgayDangKi = data["baoHiemDansu_NgayDangKi"] ? moment(data["baoHiemDansu_NgayDangKi"].toString()) : <any>undefined;
            this.baoHiemDansu_Phi = data["baoHiemDansu_Phi"];
            this.baoHiemTuNguyen_NgayDangKi = data["baoHiemTuNguyen_NgayDangKi"] ? moment(data["baoHiemTuNguyen_NgayDangKi"].toString()) : <any>undefined;
            this.baoHiemTuNguyen_Phi = data["baoHiemTuNguyen_Phi"];
        }
    }

    static fromJS(data: any): XeGroup4Dto {
        data = typeof data === 'object' ? data : {};
        let result = new XeGroup4Dto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["dangKiem_NgayDangKiem"] = this.dangKiem_NgayDangKiem ? this.dangKiem_NgayDangKiem.toISOString() : <any>undefined;
        data["dangKiem_Phi"] = this.dangKiem_Phi;
        data["dkDuongBo_NgayDangKi"] = this.dkDuongBo_NgayDangKi ? this.dkDuongBo_NgayDangKi.toISOString() : <any>undefined;
        data["dkDuongBo_Phi"] = this.dkDuongBo_Phi;
        data["baoHiemDansu_NgayDangKi"] = this.baoHiemDansu_NgayDangKi ? this.baoHiemDansu_NgayDangKi.toISOString() : <any>undefined;
        data["baoHiemDansu_Phi"] = this.baoHiemDansu_Phi;
        data["baoHiemTuNguyen_NgayDangKi"] = this.baoHiemTuNguyen_NgayDangKi ? this.baoHiemTuNguyen_NgayDangKi.toISOString() : <any>undefined;
        data["baoHiemTuNguyen_Phi"] = this.baoHiemTuNguyen_Phi;
        return data; 
    }
}

export interface IXeGroup4Dto {
    ma: number | undefined;
    xe_Ma: string | undefined;
    xe_Ten: string | undefined;
    xe_Gia: number | undefined;
